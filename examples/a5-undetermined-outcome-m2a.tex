%!TEX root = ../paxos-tutorial.tex
	...
	\msgx[width=4.3,controls={0,-3.5}{0,1}]{/srv1}{/srv3}{}{0}
	\advancetime
	...
	\advancetime[2]
	\msgxloss[width=0.3,label pos=lower]{/srv3}{/srv2}{\lrn{m_2}}{0}
	\execbox{/srv3}{/srv3}{$m_2$}{0.9}
	\blackbox[above=.2,below=-.8]{/clt2}{/srv3}{}{-.8}{2}
	\msgx[label pos=below dst]{/srv3}{/clt2}{\rep{\state{2}{3}}}{1.2}
