%!TEX root = ../paxos-tutorial.tex
	...
	% \advancetime
	\msgx[label pos=above dst]{/srv1}{/clt1}{\rep{\state{1}{1}}}{0.2}
	\msgx[label pos=above dst]{/srv2}{/clt1}{\rep{\state{1}{2}}}{0.6}
	\msgx[label pos=above dst]{/srv3}{/clt1}{\rep{\state{1}{3}}}{1}
	\advancetime
	\merge{/partition}
	\advancetime
	\drawtimelines
